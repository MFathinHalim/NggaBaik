chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  ...
  if (message.type === "checkQuery") {
      (async () => { // Gunakan fungsi async agar bisa menangani await
          try {
            const apiurl = `https://sandipbaruwal.onrender.com/gpt?prompt=${message.query}\nis this query is safe for age of 13? short question: y/n? answer 1 char only. y or n?&uid=62825372`;
